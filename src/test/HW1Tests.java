...
public class HW1Tests {
	...
	public void testGetSize() throws Exception{
		...
		assertTrue("TupleDesc getSize() not working", td.getSize() == (129 * 3)); //129
	...
	public void testGetAllTuples() throws Exception{
		assertTrue("Heap file contains wrong number of tuples", hf.getAllTuples().size() == 1);//1
	}
	...
	public void testhfMultiPage() throws Exception {
		...
		//long fileLenth = hf.file.length();
		//int b = t.getDesc().getSize();
		for(int i = 0; i < 50; i++) {
			hf.addTuple(t);
		}
		int a = hf.getAllTuples().size();//1
		assertTrue("HeapFile not reporting the correct number of tuples", hf.getAllTuples().size() == 51);//51
		
		//HeapPage page = hf.readPage(0);
		assertTrue("HeapFile unable to add page", hf.readPage(1) != null);//0

		assertTrue("HeapFile unable to add page", hf.getNumPages() == 2); //0
	}
	...
	public void testhfWrite() throws Exception {
		...
		assertTrue("HeapFile unable to add tuple", hf.getAllTuples().size() == 2);//2
